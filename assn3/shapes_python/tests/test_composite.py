...
class TestRectangle(unittest.TestCase):
    ...
    def testMove(self):
        ...
        cm3.move(4.2, 1.1)
        self.assertEqual(cm3.getShape(0).getShape(0).point1, Point(5.2, 2.1))
        self.assertEqual(cm3.getShape(0).getShape(0).point2, Point(8.2, 2.1))
        self.assertEqual(cm3.getShape(0).getShape(0).point3, Point(8.2, 4.1))
        self.assertEqual(cm3.getShape(0).getShape(0).point4, Point(5.2, 4.1))
        self.assertEqual(cm3.getShape(1).center, Point(4.2, 1.1))
        self.assertEqual(cm3.getShape(1).point1, Point(7.2, 1.1))
        self.assertEqual(cm3.getShape(1).point2, Point(4.2, 3.1))
        self.assertEqual(cm3.getShape(2).getShape(0).point1, Point(5.2, 3.1))
        self.assertEqual(cm3.getShape(2).getShape(0).point2, Point(9.2, 2.1))
        self.assertEqual(cm3.getShape(2).getShape(0).point3, Point(7.2, 4.1))
        self.assertEqual(cm3.getShape(2).getShape(1).center, Point(4.2, 1.1))
        self.assertEqual(cm3.getShape(2).getShape(1).point1, Point(6.2, 1.1))
        self.assertEqual(cm3.getShape(2).getShape(1).point2, Point(4.2, 3.1))
        cm3.move(-3.1, -0.5)
        self.assertEqual(cm3.getShape(0).getShape(0).point1, Point(2.1, 1.6))
        self.assertEqual(cm3.getShape(0).getShape(0).point2, Point(5.1, 1.6))
        self.assertEqual(cm3.getShape(0).getShape(0).point3, Point(5.1, 3.6))
        self.assertEqual(cm3.getShape(0).getShape(0).point4, Point(2.1, 3.6))
        self.assertEqual(cm3.getShape(1).center, Point(1.1, 0.6))
        self.assertEqual(cm3.getShape(1).point1, Point(4.1, 0.6))
        self.assertEqual(cm3.getShape(1).point2, Point(1.1, 2.6))
        self.assertEqual(cm3.getShape(2).getShape(0).point1, Point(2.1, 2.6))
        self.assertEqual(cm3.getShape(2).getShape(0).point2, Point(6.1, 1.6))
        self.assertEqual(cm3.getShape(2).getShape(0).point3, Point(4.1, 3.6))
        self.assertEqual(cm3.getShape(2).getShape(1).center, Point(1.1, 0.6))
        self.assertEqual(cm3.getShape(2).getShape(1).point1, Point(3.1, 0.6))
        self.assertEqual(cm3.getShape(2).getShape(1).point2, Point(1.1, 2.6))
